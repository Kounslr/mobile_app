...
import 'package:kounslr/src/ui/views/journal_entry_view/components/journal_entry_view_header.dart';
import 'package:kounslr/src/ui/views/journal_entry_view/components/summary_text_field.dart';
import 'package:kounslr/src/ui/views/journal_entry_view/components/tag_text_field.dart';
import 'package:kounslr/src/ui/views/journal_entry_view/components/title_text_field.dart';

class JournalEntryView extends StatefulWidget {
  const JournalEntryView(this.entry, this.allEntries, {Key? key}) : super(key: key);
...
class _JournalEntryViewState extends State<JournalEntryView> {
  ...
  Widget build(BuildContext context) {
    return KounslrScaffold(
      backgroundColor: KounslrMethods.alternateCanvasColor(context),
  ...
  Widget _body(BuildContext context) {
    return Expanded(
      child: Column(
        children: [
          TagTextField(tags: _tags!, key: const Key('Tag')),
